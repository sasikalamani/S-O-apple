...
trainIn = [ ([0] * 667) for row in range(len(trainScore)) ]
testIn = [ ([0] * 667) for row in range(len(testScore)) ]
trainIn1 = [ ([0] * 11909) for row in range(len(trainScore)) ]
testIn1 = [ ([0] * 11909) for row in range(len(testScore)) ]
...
def inout():
    return trainIn, testIn, trainIn1, testIn1, trainScore, testScore
